...
public class SysConfigPath extends com.querydsl.sql.RelationalPathBase<SysConfig> {

    public static final SysConfigPath sysConfig = new SysConfigPath("sys_config");
